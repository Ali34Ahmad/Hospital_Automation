...
import com.example.email_verification.otp_verification.naviation.EmailOtpVerificationRoute
...
class OtpVerificationViewModel(
    ...
    init {
        _uiState.update {
            it.copy(
                email = savedStateHandle.toRoute<EmailOtpVerificationRoute>().email,
                password = savedStateHandle.toRoute<EmailOtpVerificationRoute>().password
                    ?: "",
                navigateToResetPassword = savedStateHandle.toRoute<EmailOtpVerificationRoute>().navigateToResetPassword,
            )
        }
    }
