package com.example.upload_profile_image.main
...
class UploadProfileImageViewModel(
    ...
    fun getUiActions(
        navActions: UploadProfileImageNavigationUiActions,
    ): UploadProfileImageUiActions = UploadProfileImageUiActions(
        navigationActions = navActions,
        businessActions = getBusinessUiActions()
    )

    private fun getBusinessUiActions(): UploadProfileImageBusinessUiActions =
        object : UploadProfileImageBusinessUiActions {
