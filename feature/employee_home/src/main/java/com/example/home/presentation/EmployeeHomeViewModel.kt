...
class EmployeeHomeViewModel(
    ...
    fun getUiActions(
        navActions: EmployeeHomeNavigationUiActions,
    ): EmployeeEmployeeEmployeeHomeUiActions = EmployeeEmployeeEmployeeHomeUiActions(
        navigationActions = navActions,
        businessActions = getBusinessUiActions()
    )

    private fun getBusinessUiActions(): EmployeeHomeBusinessUiActions = object : EmployeeHomeBusinessUiActions {
