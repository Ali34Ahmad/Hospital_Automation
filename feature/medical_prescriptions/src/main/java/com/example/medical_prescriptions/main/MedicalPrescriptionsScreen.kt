...
@Composable
fun MedicalPrescriptionsScreen(
    uiState: MedicalPrescriptionsUiState,
    uiActions: MedicalPrescriptionsUiActions,
    prescriptions: LazyPagingItems<PrescriptionWithUser>,
    ...
    LaunchedEffect(prescriptions.loadState.refresh) {
        prescriptions.let {
                        ...
                        items(prescriptions.itemCount) { index ->
                            ...
                            when (medicalPrescription) {
                                null -> Unit
                                    ...
                                    onClick = {
                                        uiActions.navigateToMedicalPrescriptionDetailsScreen(
