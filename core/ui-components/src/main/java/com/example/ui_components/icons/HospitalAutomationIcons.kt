package com.example.ui_components.icons

import com.example.ui_components.R

object HospitalAutomationIcons {
    val add = R.drawable.add
    val man = R.drawable.man_2
    ...
    val certificate = R.drawable.developer_guide
    val personOff = R.drawable.person_off
